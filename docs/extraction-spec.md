...
|---|---|---|---|---|
| LLaVA-Med-1.5 | Mistral-7B-Instruct | 32 | **L0–L4** (frozen 2026-05-30 by 50-case pilot, mean IoU 0.038). | Literature prior was L14–18 ([arxiv 2503.06287](https://arxiv.org/html/2503.06287), [arxiv 2411.10950](https://arxiv.org/html/2411.10950v1)), but our IoU/AUC pilot favors L0–L4 — **same early-layer pattern as MedGemma**. CC/NSS peak slightly later at L4–L10, suggesting metric-dependent layer selection nuance worth a paper paragraph. Overall signal is materially weaker than MedGemma's (AUC 0.61 vs 0.69, NSS 0.12 vs 0.95); needs 24×24 random baseline to confirm above-random. Used the [chaoyinshe HF-format conversion](https://huggingface.co/chaoyinshe/llava-med-v1.5-mistral-7b-hf) because the original microsoft/ checkpoint's `llava_mistral` model_type doesn't deserialize cleanly in transformers v5. See `data/pilot/llavamed/layer_window.json`. |
